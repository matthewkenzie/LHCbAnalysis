...
Bc2Dmunu::AnalysisPlotter::AnalysisPlotter(TString _name, const Variables_Analysis *_v):
...
Bc2Dmunu::AnalysisPlotter::~AnalysisPlotter(){}

void Bc2Dmunu::AnalysisPlotter::defineHistograms(){
  ...
  addHist("bdtoutput", "BDT", 100, -1, 1, "R" );
...
void Bc2Dmunu::AnalysisPlotter::defineDrawingConfig(){
  ...
  addDrawOpt("data_run1",   "Data Run 1", 11, 12);
  setDrawOptDefaultPoint(kBlack);

  addDrawOpt("data_run2",   "Data Run 2", 15, 16, 17);
  setDrawOptDefaultPoint(kGreen+2);
...
bool Bc2Dmunu::AnalysisPlotter::fillHistograms(){
  ...
  fillHist("bdtoutput"       , v->bu_rejection_bdtoutput );
